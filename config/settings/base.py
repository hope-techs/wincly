...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///wincly'),
}
...
MIGRATION_MODULES = {
    'sites': 'wincly.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'wincly.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
